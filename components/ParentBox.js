...
You can see letter count, word count, line count, and text memory size in the Statistics section.
You can also set text size according to your requirements and change the theme of your choice.

What is Magic Spell? [BETA]
Need a 1000 words article and stuck on 960? Use Magic Spell and it will add relevant characters to your article to make it even longer.
Not just an article, try this with anything. Story, Letter, Cover, and more.
...
It works on all devices, Sounds good? Well, there is a lot more to come. 
This project is Open Source so if you want any new feature, you can add them yourself by contributing to our GitHub repository or requesting a feature.
  `;
  useEffect(() => {
